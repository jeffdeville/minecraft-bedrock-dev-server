...
""", mode=0o755)
    ...
    # 5b. who may join: an allowlist the control plane manages (empty until the
    # admin or the learner adds a gamertag; nobody joins by accident)
    allow = home / "data" / "allowlist.json"
    if not allow.exists():
        allow.write_text("[]\n")
    os.chown(allow, UID, UID)
